...
class RoleHumansCommand extends Command {
  constructor() {
    super({
      name: "rolehumans",
      ...
      examples: [
        ...
        "rolehumans add @Verified --include @Pending",
        "rolehumans remove @Event --exclude @Staff",
      ],
      aliases: ["masshumans", "bulkhumans"],
      cooldown: 60,
...
export default new RoleHumansCommand();